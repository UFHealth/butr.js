...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _to__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./to */ \"./src/to.js\");\n/* harmony import */ var _marker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./marker */ \"./src/marker.js\");\n/* harmony import */ var _autoAnchors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./autoAnchors */ \"./src/autoAnchors.js\");\n/* harmony import */ var _autoSidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./autoSidebar */ \"./src/autoSidebar.js\");\n/* harmony import */ var _stickyNav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./stickyNav */ \"./src/stickyNav.js\");\n\n\n\n\n\n\nvar init = function init(options) {\n  // To\n  if (options.To || options.AutoAnchors) {\n    Object(_to__WEBPACK_IMPORTED_MODULE_0__[\"To\"])({\n      threshold: options.threshold || 0\n    });\n  } // Marker\n\n\n  if (options.Marker) {\n    Object(_marker__WEBPACK_IMPORTED_MODULE_1__[\"Marker\"])();\n  } // Sidebar\n\n\n  if (options.AutoSidebar) {\n    Object(_autoSidebar__WEBPACK_IMPORTED_MODULE_3__[\"AutoSidebar\"])({\n      olClass: options.olClass || '',\n      liClass: options.liClass || '',\n      aClass: options.aClass || ''\n    });\n  } // Anchors\n\n\n  if (options.AutoAnchors) {\n    Object(_autoAnchors__WEBPACK_IMPORTED_MODULE_2__[\"AutoAnchors\"])({\n      to: {\n        threshold: options.threshold || 0\n      }\n    });\n  } // Sticky Nav\n\n\n  if (options.StickyNav) Object(_stickyNav__WEBPACK_IMPORTED_MODULE_4__[\"StickyNav\"])();\n};\n\nwindow.Butr = {\n  init: init\n};\n\n//# sourceURL=webpack://%5Bname%5D/./src/butr.js?");
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: State, throttle, debounce, timingFunctions, appendClasses, animate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
